...
--
-- REPRESENTS A USER ENTERING THE PLATFORM
...
--
-- REPRESENTS A USER ENTERING A GAME (INSIDE A SUBJECT)
...
--
-- REPRESENTS A USER ATTEMPTING A LEVEL OF A GAME
DROP TABLE IF EXISTS `play`;
CREATE TABLE `play` (
  `IDPlay` int NOT NULL AUTO_INCREMENT,
  `IDGameSession` int NOT NULL,  
  `Level` int NOT NULL DEFAULT 1, --  Number representing the level inside the game (e.g. Level 1)
  `Score` int DEFAULT 0, 
  `Time` decimal(8,3) DEFAULT 0.000, --  Duration in seconds (used by rank in case two players have the same score)
  `Completed` tinyint(1) DEFAULT 0, --  Defines if the player "passed" the level
  PRIMARY KEY (`IDPlay`),
...
CREATE TABLE `games` (
  ...
  `UrlImage` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `Name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL, 
  `Open` tinyint(1) NOT NULL, -- GlobalOpen (for all subjects)
  `Visible` tinyint(1) NOT NULL, -- GlobalVisible (for all subjects)
  PRIMARY KEY (`IDGame`),
  UNIQUE KEY `idx_game_name` (`Name`) 
...
CREATE TABLE `subjects` (
  ...
  `UrlImgSubject` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `UrlImgInside` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
CREATE TABLE `subjectGroups` (
  ...
  PRIMARY KEY (`IDGroup`),
  UNIQUE KEY `idx_group_subject` (`Name`, `IDSubject`), 
...
-- AUXILIAR FOR LINKING GROUPS AND USERS
...
--
-- AUXILIAR FOR LINKING SUBJECTS AND GAMES (USED TO STORE LOCAL SETTINGS)
DROP TABLE IF EXISTS `content`;
CREATE TABLE `content` (
  `IDSubject` int NOT NULL,
  `IDGame` int NOT NULL,
  `Open` tinyint(1) NOT NULL DEFAULT 0,  -- LocalOpen (only for the subject)
  `Visible` tinyint(1) NOT NULL DEFAULT 0,  -- LocalVisible (only for the subject)
