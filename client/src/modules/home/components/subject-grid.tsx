...
const SubjectGrid: React.FC = () => {
	...
	// We filter the visible subjects before rendering to see if there are any
		...
		<div className='container'>
			{loading ? (
				...
				<div className='row custom-flex-center text-center'>
					...
					{/* If there is no error, it is not loading and there are no visible subjects, we show a warning */}
					{!error && visibleSubjects.length === 0 ? (
						...
						/* If there are subjects, we do the normal map */
