...
const SubjectGroupSection: React.FC<SubjectGroupSectionProps> = ({ subjectId }) => {
    ...
    // CSV import hook. We pass 'fetchGroups' to it so that it reloads the list if new groups are created in the CSV.
    const { 
        uploadFile, 
    ...
    return (
        <div className="d-flex flex-column gap-3">
            ...
            {report && !uploadLoading && (
                <div className="card bg-dark border-success p-3">
                    <div className="d-flex justify-content-between align-items-center mb-3">
                        <h6 className="text-success m-0 fw-bold">Import report</h6>
                    ...
                    {report.errorDetails && report.errorDetails.length > 0 && (
                        <div className="mt-2">
                            <h6 className="text-danger small fw-bold mb-1">Error details({report.errorDetails.length}):</h6>
            ...
            <div className="d-flex flex-column gap-2 mt-2">
                {groupsLoading && <div className="small text-muted">Loading groups...</div>}
