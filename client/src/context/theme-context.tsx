...
import { Theme } from '../modules/shared/api/domain/theme';
import { themeRepository } from '../modules/shared/api/repository/theme.repository';
...
export const ThemeProvider: React.FC<{ children: React.ReactNode }> = ({
	...
	const applyTheme = (newTheme: Theme) => {
		...
		document.documentElement.style.setProperty('--text', newTheme.textColor);
	};
